...
class Image {
    ...
    public function concat($newfilename,$images = array()) {
        $matrix = "2x2";
        $base = ImageCreateTrueColor(200, 300);
        ...
        for ($i=0;$i<2;$i++) {
            for ($j=0;$j<2;$j++) {
                ...
                ImageCopy($base, $image_p, $j*$max_width, $i*$max_height+($max_height-$new_height)/2, 0, 0, $new_width, $new_height);
