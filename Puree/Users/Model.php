...
class UsersModel extends \Model {
    ...
    public function post($req) {
        $code = rand();
        $subject = _("User confirmation");
        $message = BASE."users/".$req['post']['id']."?code=".$code."&view=confirm";
...
/*
Twitter user confirmation

Hi, miyaa

Twitterアカウントを確認するにはこのリンクをクリックし、このメールアドレス(miyaa@yahoo.co.jp)を照合してください。
http://twitter.com/user/confirm_email/miyaa/2ECF2-HCG39
